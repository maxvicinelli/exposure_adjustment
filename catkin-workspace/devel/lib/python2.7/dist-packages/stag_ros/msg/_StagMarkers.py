...
"""autogenerated by genpy from stag_ros/StagMarkers.msg. Do not edit."""
import codecs
import sys
...
class StagMarkers(genpy.Message):
  _md5sum = "651766ef07e9246eea9b89a8695f7aa1"
  _type = "stag_ros/StagMarkers"
...
"""
  ...
  _slot_types = ['std_msgs/Header','stag_ros/StagMarker[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(StagMarkers, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.markers:
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        _x = val1
        buff.write(_get_struct_If().pack(_x.id, _x.reprojection_error))
        _v3 = val1.pose
        _v4 = _v3.header
        _x = _v4.seq
        buff.write(_get_struct_I().pack(_x))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        (_x.id, _x.reprojection_error,) = _get_struct_If().unpack(str[start:end])
        _v11 = val1.pose
        _v12 = _v11.header
        start = end
        end += 4
