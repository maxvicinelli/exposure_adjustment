...
if("TRUE" STREQUAL "TRUE")
  set(spinnaker_sdk_camera_driver_SOURCE_PREFIX /home/sam/catkin-workspace/src/spinnaker_sdk_camera_driver)
  set(spinnaker_sdk_camera_driver_DEVEL_PREFIX /home/sam/catkin-workspace/devel)
  ...
  set(spinnaker_sdk_camera_driver_INSTALL_PREFIX /home/sam/catkin-workspace/install)
...
if(NOT "/home/sam/catkin-workspace/devel/include;/home/sam/catkin-workspace/src/spinnaker_sdk_camera_driver/include;/usr/local/include;/usr/local/include/opencv;/usr/include/x86_64-linux-gnu " STREQUAL " ")
  set(spinnaker_sdk_camera_driver_INCLUDE_DIRS "")
  set(_include_dirs "/home/sam/catkin-workspace/devel/include;/home/sam/catkin-workspace/src/spinnaker_sdk_camera_driver/include;/usr/local/include;/usr/local/include/opencv;/usr/include/x86_64-linux-gnu")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'spinnaker_sdk_camera_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/sam/catkin-workspace/src/spinnaker_sdk_camera_driver/${idir}'.  ${_report}")
    endif()
    _list_append_unique(spinnaker_sdk_camera_driver_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "/usr/local/lib/libopencv_calib3d.so.3.4.9;/usr/local/lib/libopencv_core.so.3.4.9;/usr/local/lib/libopencv_dnn.so.3.4.9;/usr/local/lib/libopencv_features2d.so.3.4.9;/usr/local/lib/libopencv_flann.so.3.4.9;/usr/local/lib/libopencv_highgui.so.3.4.9;/usr/local/lib/libopencv_imgcodecs.so.3.4.9;/usr/local/lib/libopencv_imgproc.so.3.4.9;/usr/local/lib/libopencv_ml.so.3.4.9;/usr/local/lib/libopencv_objdetect.so.3.4.9;/usr/local/lib/libopencv_photo.so.3.4.9;/usr/local/lib/libopencv_shape.so.3.4.9;/usr/local/lib/libopencv_stitching.so.3.4.9;/usr/local/lib/libopencv_superres.so.3.4.9;/usr/local/lib/libopencv_video.so.3.4.9;/usr/local/lib/libopencv_videoio.so.3.4.9;/usr/local/lib/libopencv_videostab.so.3.4.9;/usr/local/lib/libopencv_viz.so.3.4.9;/usr/lib/x86_64-linux-gnu/libunwind.so;/usr/lib/x86_64-linux-gnu/libunwind-x86_64.so")
